/**
 * E2E Test: Coinbase Client → All Servers
 * 
 * Run: bun test tests/e2e/coinbase-to-all-servers.test.ts
 * 
...
// Server creators - same as Faremeter but with Coinbase x402 format
...
describe("Coinbase Client → Servers", () => {
