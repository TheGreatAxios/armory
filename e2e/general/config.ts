...
export const TEST_PAYER_ADDRESS =
  "0x742d35Cc6634C0532925a3b844Bc9e7595f0bEb1" as const;
export const TEST_PAY_TO_ADDRESS =
...
export const TEST_ASSET_ID =
  "eip155:84532/erc20:0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48" as const;
...
export const getRandomPort = (): number =>
  8800 + Math.floor(Math.random() * 200);
 ...
 */
export const waitForSettlement = async (_txHash: string): Promise<void> => {
