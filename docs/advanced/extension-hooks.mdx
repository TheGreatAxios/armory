...
description: Use protocol extensions and lifecycle hooks together
---

# Extensions and Hooks

Armory has two separate concepts:

1. `extensions`: protocol data attached to x402 payloads/challenges (`extensions` object on wire format).
2. `hooks`: lifecycle callbacks in the client or middleware flow.

Use hooks to inspect or mutate context during payment flow. Use extensions to send or read protocol-level metadata.
