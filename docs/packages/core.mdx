...
The `@armory/core` package contains the fundamental types, encoding, EIP-712 signing, network configurations, and token registry for the X-402 protocol.
...
```typescript
import { getNetworkConfig } from '@armory/core';
