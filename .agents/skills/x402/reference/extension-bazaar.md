...
Facilitators implementing the bazaar extension expose a discovery API:
...
- Enables automatic resource discovery and cataloging
- Schema-validated endpoint specifications
- Supports both query parameter and body-based requests
- Facilitator implementation is flexible (database, API, etc.)
- Optional output format documentation

## References

- [Core x402 Specification](../x402-specification.md)
- [Coinbase x402 Bazaar Extension](https://github.com/coinbase/x402/blob/main/specs/extensions/bazaar.md)
